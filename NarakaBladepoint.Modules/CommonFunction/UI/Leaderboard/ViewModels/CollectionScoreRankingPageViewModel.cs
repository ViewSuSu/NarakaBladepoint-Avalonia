...
namespace NarakaBladepoint.Modules.CommonFunction.UI.Leaderboard.ViewModels
{
    internal class CollectionScoreRankingPageViewModel : ViewModelBase
    {
        ...
        private List<IImage> _avatarSources = new();
        ...
        private async void InitializeData()
        {
            try
            {
                ...
                _avatarSources = avatars.Select(a => a.IImage).ToList();
            }
            catch
            {
                _avatarSources = new List<IImage>();
            }
        ...
        private IImage GetRandomAvatar(Random random)
        {
