...
namespace NarakaBladepoint.Modules.CommonFunction.UI.Store.ViewModels
{
    ...
    {
        private ObservableCollection<IImage> _overviewImages;
        ...
        public ObservableCollection<IImage> OverviewImages
        {
            get
            {
                if (_overviewImages == null)
                {
                    _overviewImages = new ObservableCollection<IImage>(ResourceImageReader.GetAllStoreOverviewImages());
                }
