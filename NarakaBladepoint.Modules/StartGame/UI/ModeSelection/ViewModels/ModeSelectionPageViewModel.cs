...
namespace NarakaBladepoint.Modules.StartGame.UI.ModeSelection.ViewModels
{
    internal class ModeSelectionPageViewModel : CanRemoveHomePageRegionViewModelBase
    {
        ...
        private IImage _firstHeroAvatar;
        private IImage _secondHeroAvatar;
        private IImage _thirdHeroAvatar;

        public IImage FirstHeroAvatar
        {
        ...
        public IImage SecondHeroAvatar
        {
