...
namespace NarakaBladepoint.Modules.EventCenter.UI.TimeLimitedEvent.ViewModels
{
    internal class TimeLimitedEventPageOneViewModel : CanRemoveMainContentRegionViewModelBase
    {
        ...
        private ObservableCollection<IImage> _timeLimitedEventImages2;
        ...
        /// 时间限制事件 Images2 图片集合
        /// </summary>
        public ObservableCollection<IImage> TimeLimitedEventImages2
        {
        ...
        private void InitializeRewardItems()
        {
            ...
            foreach (var IImage in rewardImages)
            {
        ...
        {
            TimeLimitedEventImages2 = new ObservableCollection<IImage>();

            // 从 ResourceImageReader 读取所有时间限制事件 Images2 图片
            var images2 = ResourceImageReader.GetAllTimeLimitedEventImages2();

            foreach (var IImage in images2)
            {
                TimeLimitedEventImages2.Add(IImage);
            }
        }
